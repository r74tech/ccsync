...
describe("Sync module", () => {
	...
	describe("syncProject", () => {
		it("should sync all claude.md files from a project", async () => {
			...
			const rootContent = await readFile(join(projectDestDir, "claude.md"), "utf-8")
			const docsContent = await readFile(join(projectDestDir, "docs", "claude.md"), "utf-8")
			const srcContent = await readFile(join(projectDestDir, "src", "claude.md"), "utf-8")
		...
		it("should copy files preserving directory structure", async () => {
			...
			const destFile = join(destDir, project.name, "deep", "nested", "path", "claude.md")
		...
		it("should overwrite existing files", async () => {
			...
			const content = await readFile(join(projectDestDir, "claude.md"), "utf-8")
